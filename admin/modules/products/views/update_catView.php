            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST">
                        ...
                        <input type="text" class="form-control" name="cat_title" id="title" value="<?php echo $info_cat['cat_title']; ?>"> 
                        <!-- //phần thông báo  --><?php echo form_error('cat_title') ?>

                        <label for="slug" class="form-lable">Slug ( Friendly_url ):</label>
                        <input type="text" class="form-control" name="cat_slug" id="slug" value="<?php echo $info_cat['cat_slug']; ?>">
                        <!-- //phần thông báo  --><?php echo form_error('cat_slug') ?>
