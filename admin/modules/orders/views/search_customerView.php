                ...
                <form method="POST" action="?mod=orders&controller=customer&action=apply_status" class="form-actions">
                    ...
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <?php if (!empty($list_search_customer)) {
                                $t = 0;
                            ?>
                            <tbody>
                                <?php 
                                foreach ($list_search_customer as $customer) {
                                    $t ++;
                                ?> 
                                <tr>
                                    ...
                                    <td class="">
                                        ...
                                        <ul class="list-operation fl-right">
                                            ...
                                            <li><a href="?mod=orders&controller=customer&action=delete&customer_id=<?php echo $customer['customer_id']?>" title="Xóa" onclick="return confirm('Bạn có chắc thực hiện thao tác này?')" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
