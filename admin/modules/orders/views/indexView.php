                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        ...
                                        <ul class="list-operation fl-right">
                                            ...
                                            <li><a href="?mod=orders&action=delete&order_id=<?php echo $order['order_id']?>" title="Xóa" class="delete" onclick="return confirm('Bạn có chắc thực hiện thao tác này?')"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
